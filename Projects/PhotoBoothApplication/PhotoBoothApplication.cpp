...
// PhotoBoothApplication.cpp : Définit les comportements de classe pour l'application.
//
...
BEGIN_MESSAGE_MAP(CPhotoBoothApplicationApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// construction CPhotoBoothApplicationApp

CPhotoBoothApplicationApp::CPhotoBoothApplicationApp()
{
...
// Seul et unique objet CPhotoBoothApplicationApp

CPhotoBoothApplicationApp theApp;


// initialisation de CPhotoBoothApplicationApp

BOOL CPhotoBoothApplicationApp::InitInstance()
{
